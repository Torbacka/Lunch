...
- **Global scope**: `/Users/daniel.torbacka/dev/private/Lunch/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/daniel.torbacka/dev/private/Lunch/.claude/notes/`)
...
2. Glob `/Users/daniel.torbacka/dev/private/Lunch/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/daniel.torbacka/dev/private/Lunch/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/daniel.torbacka/dev/private/Lunch/.claude/notes/` — works in any directory
