...
- Usage: Reference from command with `@/Users/daniel.torbacka/dev/private/Lunch/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/daniel.torbacka/dev/private/Lunch/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/daniel.torbacka/dev/private/Lunch/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
