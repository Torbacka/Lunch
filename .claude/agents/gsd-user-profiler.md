...
<reference>
@/Users/daniel.torbacka/dev/private/Lunch/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/daniel.torbacka/dev/private/Lunch/.claude/get-shit-done/references/user-profiling.md` to load:
