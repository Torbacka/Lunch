...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/daniel.torbacka/dev/private/Lunch/.claude
                  → checks /Users/daniel.torbacka/dev/private/Lunch/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/daniel.torbacka/dev/private/Lunch/.claude/get-shit-done
                  → writes to /Users/daniel.torbacka/dev/private/Lunch/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/daniel.torbacka/dev/private/Lunch/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/daniel.torbacka/dev/private/Lunch/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/daniel.torbacka/dev/private/Lunch/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
